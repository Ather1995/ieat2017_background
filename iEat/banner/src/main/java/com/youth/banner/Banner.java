...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    protected int mIndicatorMargin = BannerConfig.PADDING_SIZE;
    protected int mIndicatorWidth;
    protected int mIndicatorHeight;
    protected int indicatorSize;
    protected int bannerBackgroundImage;
    protected int bannerStyle = BannerConfig.CIRCLE_INDICATOR;
    protected int delayTime = BannerConfig.TIME;
    protected int scrollTime = BannerConfig.DURATION;
    protected boolean isAutoPlay = BannerConfig.IS_AUTO_PLAY;
    protected boolean isScroll = BannerConfig.IS_SCROLL;
    protected int mIndicatorSelectedResId = R.drawable.gray_radius;
    protected int mIndicatorUnselectedResId = R.drawable.white_radius;
    protected int mLayoutResId = R.layout.banner;
    protected int titleHeight;
    protected int titleBackground;
    ...
    protected List<ImageView> indicatorImages;
    ...
    protected BannerPagerAdapter adapter;
    protected OnPageChangeListener mOnPageChangeListener;
    protected BannerScroller mScroller;
    protected OnBannerClickListener bannerListener;
    protected OnBannerListener listener;
    ...
    protected void handleTypedArray(Context context, AttributeSet attrs) {
        if (attrs == null) {
            return;
        }
    ...
    protected void initViewPagerScroll() {
        try {
    ...
    protected void setTitleStyleUI() {
    ...
    protected void setScaleType(View imageView) {
